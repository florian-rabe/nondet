...
\end{itemize} 
Like any predicate symbol, purity is closed under equality, i.e., if |E1| is pure and we can prove |E1=E2|, then so is |E2|.
For example, |2| and |E1 + E2| for pure |E1| 
...
function type |S->T|   & set--valued functions $\sem{S}\to\PP\sem{T}$ \\
